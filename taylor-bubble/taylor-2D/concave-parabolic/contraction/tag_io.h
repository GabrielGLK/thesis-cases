...
This is a copy of tag function with a change of iterator type
on line 298 of remove_droplets function foreach_leaf instead of
foreach_cell to avoid to overestimate number of cells.
