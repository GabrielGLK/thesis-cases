...
while i < 7:  
    try:
        PATH_REFERENCE = os.path.abspath('/media/lguo/Elements/calculation/Taylor_bubble/2D/singularity/concave-parabolic/contraction/{}/taylor_2D'.format(str(case[i])))
        ...
        PATH_COM = os.path.abspath("/media/lguo/Elements/writing/thesis-part/chapter-5/parabolic-concave/contraction/figure")
        ...
        def simulation(a):
            ...
            for time in np.arange(time_begin,time_end,1):
                ...
                ex= [1.72,0.7,1.33,1.24,1.12,1,0.9,0.81,0.69] # expansion ratio
                ...
                # calculate the arc
                mxmy = [R_ex + R_out, delta_x]
                mx1my1 = [-R_ex - R_out, delta_x]
                width = 2*R_out
                height = 2*R_out
                width_1 = 2*R_out
                height_1 = 2*R_out
