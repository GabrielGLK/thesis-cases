...
mask((x<=xx&&sq(y-L0/2) + sq(z-L0/2) > sq(R_0))? cylinder1:
xx<x&&x<9&&(sq(y-L0/2) + sq(z-L0/2) > sq(R_0)?sq(y-L0/2-R_ex+R_out)+ sq(z-L0/2)-sq(R_out):sq(y-L0/2) + sq(z-L0/2) > sq(R_0))?gra:

(x>xx&&sq(y-L0/2) + sq(z-L0/2) > sq(R_ex))?cylinder2:
none);
